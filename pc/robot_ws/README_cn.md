# 基于RDK X5的异构阿克曼-麦克纳姆双车协同调度与感知系统

本项目是一个基于 RDK X5 与 ROS 2 Humble 的异构阿克曼-麦克纳姆双车协同调度与感知系统，面向室内赛场演示和实车部署。系统包含麦克纳木配送车、阿克曼巡检车、PC 端调度控制平面、Web App 操作界面、地图显示、任务调度、事件日志和视觉检测接入接口。
