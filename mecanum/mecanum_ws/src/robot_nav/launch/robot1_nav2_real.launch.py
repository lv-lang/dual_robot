"""Start robot1 Nav2 only for the real RDK X5 robot."""
...
def _optional_nav2_bringup():
    ...
    return LogInfo(
        msg=(
            ...
            'running robot1_nav2_real.launch.py.'
        )
    )
...
def generate_launch_description():
    ...
    default_params = _share_path('robot_nav', 'params', 'robot1_nav2_real.yaml') or ''
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'use_sim_time',
            default_value='false',
            description='Real robot uses wall time by default.',
        ),
        DeclareLaunchArgument(
            'map',
        ...
        DeclareLaunchArgument(
            ...
            description='Nav2 parameter file for the real robot.',
        ),
        ...
        LogInfo(
            msg=(
                'robot_nav real: start the hardware and lidar bringup separately, then '
                'Nav2 consumes /robot1/scan and /robot1/odom and publishes /robot1/cmd_vel.'
            )
        ),
