"""Start ackermann real-robot Nav2 TEB with a robot-local map_server."""
...
def generate_launch_description():
    ...
    default_params = _share_path('ackermann_nav', 'params', 'teb_nav_params.yaml')
    default_map = _share_path('ackermann_nav', 'maps', 'real_competition_map.yaml')
    lifecycle_nodes = [
        'controller_server',
        'smoother_server',
        'planner_server',
    ...
    return LaunchDescription([
        ...
        LogInfo(msg='Starting ackermann real Nav2: local map_server + AMCL + TEB navigation.'),
